...
$p1 = new Player ( array ( 'name' => 'root', 'team' => 1 ) );
$p2 = new Player ( array ( 'name' => 'admin', 'team' => 1 ) );
$p3 = new Player ( array ( 'name' => 'zuckerberg', 'team' => 2 ) );
$p4 = new Player ( array ( 'name' => 'bob', 'team' => 2 ) );
...
$i = 0;
while (($key = $board->whoseTurn()) != "OVER" && $i < 10)
{

	echo $key->getPlayerName() . PHP_EOL;
	$i += 1;
}
